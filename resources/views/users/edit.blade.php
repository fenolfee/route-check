            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="px-6 py-4  items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900">Редактирование пользователя </h3>
                   ...
                   focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            ...
                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-700">Пароль (оставьте
                                    пустым, чтобы не менять)</label>
                                <input type="password" name="password" id="password" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm
                   focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                @error('password')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
